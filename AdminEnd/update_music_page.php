...
?>
    ...
    <div class="form-card text-center">
        ...
        <form form action="adminaction.php" method="post"  enctype="multipart/form-data">
            <!-- Name field -->
            <div class="mb-3">
            ...
            <div class="mb-3 text-start">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" id="freeUser" name="updated-user-type" value="Free User" <?php if ($userGender == 'Male') echo 'checked'; ?> required>
                    <label class="form-check-label" for="freeUser">Free User</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" id="premiumUser" name="updated-user-type" value="Premium" <?php if ($userGender == 'Female') echo 'checked'; ?> required>
                    <label class="form-check-label" for="premiumUser">Premium User</label>
                </div>
            </div>
